...
namespace InforBarcodeReader
{
    ...
    {
        //Essa classe limpa String, só mandar pra ela com o método adequado
        ...
        public static string CapCharactersToWindowsLenght(string texto)
        {
            if (texto.Length >= 200)
            {
                texto = texto.Substring(0, 150) + ".pdf";
                return texto;
            }
            return texto;
        }
